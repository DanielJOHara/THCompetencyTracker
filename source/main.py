"""
The Competency Tracker provide a user interface to maintain a record of the competencies staff
...
1.  Grid Export: An excel spreadsheet with a sheet containing a static version of the Staff
    Competency Grid for each Service Area and Staff Type combinations requested.
2.  Competency Report: An excel spreadsheet with a summary sheet for the competencies related to
    the Service Area and Staff Type combinations requested and a sheet for each competency giving
    the competency status for each staff members.
3.  Staff Report: An excel spreadsheet with a summary sheet for the staff members in the Service
    Area and Staff Type combinations requested and a sheet for each staff member giving the
    competency status for each competency.
4.  Staff Document: Word documents for the selected staff members giving the status for each
    relevant competency.

The application provides a "Data Management" window that allows for the maintenance of the master
data tables. The following data management interfaces are available:
...
The tool only supports a single user at a time with update access. There is no limit on the number
of users with read only access.
